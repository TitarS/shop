			...
			foreach ($parts as $path_id) {
				...
				if ($category_info) {
					$data['breadcrumbs'][] = array(
						...
						'href' => $this->url->link('product/categorywall', 'path=' . $path . $url)
					);
				}
			}
		} else {
...
//End Vova code
			...
			foreach($limits as $value) {
				$data['limits'][] = array(
					'text'  => $value,
					'value' => $value,
					'href'  => $this->url->link('product/categorywall', 'path=' . $this->request->get['path'] . $url . '&limit=' . $value)
				);
			}
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/product/categorywall.tpl')) {
				$this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/product/categorywall.tpl', $data));
			} else {
				$this->response->setOutput($this->load->view('default/template/product/categorywall.tpl', $data));
			}
		} else {
			$url = '';
